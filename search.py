...
def graph_search(problem, fringe):
    ...
    while fringe:
        ...
        if problem.goal_test(node.state):
            print("Cities visited: " + str(visitedCount))
            print("Cities expanded: " + str(extendedCount))
            return node
...
def RAMACOT_search(problem):
    """Search the cheapest nodes in the search tree first."""
    return graph_search(problem, RAMACOTQueue())

def RAMACOTHINT_search(problem):
    """Search the closer nodes to the solution in the search tree first."""
    return graph_search(problem, RAMACOTHINTQueue(problem))
